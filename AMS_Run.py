    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='safi123', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = '/Users/syedsafiullah/Desktop/project1/Face-Recognition-Attendance-System/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(["open", "/Users/syedsafiullah/Desktop/project1/Face-Recognition-Attendance-System/Attendance/Manually Attendance"])
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                df = pd.read_csv("/Users/syedsafiullah/Desktop/project1/Face-Recognition-Attendance-System/StudentDetails/StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='safi123', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = '/Users/syedsafiullah/Desktop/project1/Face-Recognition-Attendance-System/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(["open", "/Users/syedsafiullah/Desktop/project1/Face-Recognition-Attendance-System/Attendance/Manually Attendance/-------Check atttendance-------"])
    ...
    def log_in():
        ...
        if username == 'safi':
            if password == 'safi123':
                ...
                cs = '/Users/syedsafiullah/Desktop/project1/Face-Recognition-Attendance-System/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
